 ...
 *
 * Uses shared MediaPreview for rendering, but keeps custom:
 * - Ephemeral glowy styling
...
export default function EntityOverlay({ inVoiceMode = false }) {
    ...
    // Pause auto-advance when hovering or in fullscreen
    useEffect(() => {
    ...
    const handleBackdropClick = () => hideOverlay();
    ...
    const NavButton = ({ direction, onClick }) => (
        <button
            ...
            className={cn(
                ...
                "bg-black/50 hover:bg-black/70 text-white rounded-full p-2.5",
                "transition-all opacity-0 group-hover/overlay:opacity-100",
                ...
                >
                    <div className="relative group/overlay">
                        ...
                        <div
                            ...
                            className={cn(
                                "relative overflow-hidden shadow-2xl cursor-pointer select-none",
                                "w-[19rem] h-[14.5rem] sm:w-[22rem] sm:h-[17rem] md:w-[45vw] md:h-[34vw] lg:w-[38vw] lg:h-[29vw]",
                                "md:max-w-[640px] md:max-h-[480px] lg:max-w-[768px] lg:max-h-[576px]",
                                "ring-2 ring-cyan-400/50 hover:ring-cyan-300/70 transition-all duration-200",
                        ...
                        >
                            {isText ? (
                                <div className="absolute inset-0 flex items-center justify-center p-6 sm:p-8 md:p-10">
                                    {renderEphemeralText(currentItem.content)}
                                    <div className="absolute inset-0 pointer-events-none entity-overlay-text-glow" />
                                </div>
                            ) : (
                                <MediaPreview
