    ...
    return (
        <>
            <div className="flex flex-col gap-3" ref={containerRef}>
                        ...
                        <div className="flex items-center justify-between">
                            {title && (
                                <div className="flex items-center gap-1 sm:gap-2 min-w-0">
                                    ...
                                    <h3 className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-gray-100 truncate m-0 leading-none">
                                        {title}
                                    </h3>
                                    <span className="text-xs text-gray-500 dark:text-gray-400 flex-shrink-0 leading-none">
                                        ({sortedFiles.length}
                                        {sortedFiles.length !==
                                            localFiles.length &&
                                            ` / ${localFiles.length}`}
                ...
                {/* File list table or empty state */}
                {sortedFiles.length === 0 && filterText ? (
                    <div
