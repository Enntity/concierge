...
export class WavRecorder {
     ...
     * @returns {Promise<{blob: Blob, url: string, values: Float32Array, audioBuffer: AudioBuffer}>}
     */
     ...
     * @param {string|null} deviceId if no device provided, default device will be used
     * @returns {Promise<true>}
     */
    ...
    async read() {
        ...
        this.log("Reading ...");
        return await this._event("read");
    }

    /**
     * Saves the current audio stream to a file
     * @param {boolean} force Force saving while still recording
     * @returns {Promise<{blob: Blob, url: string, channelCount: number, sampleRate: number, duration: number}>}
     */
